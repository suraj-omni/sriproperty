                  ...
                  <Row className={`${defpadding} section-bg `}>
                    <Col>
                      ...
                      <p className="ad-view-notice-font">
                        ...
                        posted by the advertiser. sriproperty.lk is only
                        providing the service of list the advert by the
                        advertiser. You will need to contact the advertiser
                        directly via email or phone. You will need to take
                        necessary precautions when dealing in monetary matters
                        and sign or share any documents.
                      </p>
                    </Col>
                  </Row>
                </Container>
...
export default connect(mapStateToProps)(AdViewMain);
