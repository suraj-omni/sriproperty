...
class AdminAdvertImageUpload extends Component {
  constructor(props) {
    super(props);
    this.state = {
      textboxclass: "p-2",
  ...
  render() {
    ...
    const disable_all = advertStatus === ADVERT_STATUS_INREVIEW ? false : true;
...
AdminAdvertImageUpload.propTypes = {
